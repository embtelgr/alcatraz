...
export default (req, res) => {
  ...
  const params = {
    ...
    Message: {
      Subject: {
        Data: `Contact form submission from your website alcatraztourstickets.com`,
      },
      Body: {
        Text: {
          Data: `
          ...
          You have got a new contact enquiry from your website alcatraztourstickets.com (Contact Page). 

          Here are the details. 

          Name: ${body.name}\n
          Email: ${body.email}\n
          Agent Referral Name: ${body.agent}\n
