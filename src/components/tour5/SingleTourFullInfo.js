                        ...
                        <div className="gdlr-core-pbf-element">
                            <div className="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr" style={{paddingBottom:'35px'}} >
                                <div className="gdlr-core-title-item-title-wrap">
                                    <h6 className="gdlr-core-title-item-title gdlr-core-skin-title" style={{fontSize:'24px', fontWeight:'600', letterSpacing:'0px', textTransform:'none'}} ><span className="gdlr-core-title-item-left-icon" style={{fontSize:'18px'}} ><i className="fa fa-file-text-o"  ></i></span>Muir Woods Tour Summary<span className="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h6></div>
                            </div>
                        </div>
                        <div className="gdlr-core-pbf-element">
                            <div className="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                <div className="gdlr-core-text-box-item-content">
                                    <p>Wander through an ancient coastal redwood forest and explore the artistic bayside enclave of Sausalito on this half-day tour from San Francisco. Travel across the Golden Gate Bridge to visit Muir Woods, home to some of the oldest and tallest trees on Earth. Then, soak up stellar views of the San Francisco skyline and browse art galleries along the Sausalito waterfront. At the end of your tour choose between getting dropped off at Union Square in San Francisco or taking the Sausalito ferry back to San Francisco.</p>
                                    <ul>
                                        <li>Half-day tour of Muir Woods and Sausalito from San Francisco</li>
                                        <li>Explore the giant redwood sequoia trees at Muir Woods</li>
                                        <li>Shop and browse in Sausalito, California's prettiest town</li>
                                        <li>Drive across the Golden Gate Bridge</li>
                                    </ul>
                        ...
                        <div className="gdlr-core-pbf-element">
                            <div className="gdlr-core-gallery-item gdlr-core-item-pdb clearfix  gdlr-core-gallery-item-style-slider gdlr-core-item-pdlr ">
                                ...
                                <GallerySec 
                                    images = {[
                                        {
                                            src: require('../../upload/muirwoods/1.jpg').default,
                                            thumbnail: require('../../upload/muirwoods/1.jpg').default,
                                        
                                        },
                                        {
                                            src: require('../../upload/muirwoods/2.jpg').default,
                                            thumbnail: require('../../upload/muirwoods/2.jpg').default, 
                                        
                                        },
                                        {
                                            src: require('../../upload/muirwoods/3.jpg').default,
                                            thumbnail: require('../../upload/muirwoods/3.jpg').default,   
                                        },
                                        {
                                            src: require('../../upload/muirwoods/4.jpg').default,
                                            thumbnail: require('../../upload/muirwoods/4.jpg').default,   
                                        },
                                        {
                                            src: require('../../upload/muirwoods/5.jpg').default,
                                            thumbnail: require('../../upload/muirwoods/5.jpg').default,   
                                        },
                                        {
                                            src: require('../../upload/muirwoods/6.jpg').default,
                                            thumbnail: require('../../upload/muirwoods/6.jpg').default,   
                                        }
                                    ]}
                                />
