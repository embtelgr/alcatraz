                ...
                <div className="tourmaster-single-header-container-inner">
                    ...
                    <div className="tourmaster-header-price tourmaster-item-mglr">
                        ...
                        <div className="tourmaster-header-price-wrap">
                            ...
                            <div className="tourmaster-tour-price-wrap tourmaster-discount"><span className="tourmaster-tour-price"><span className="tourmaster-head">From</span><span className="tourmaster-tail">$130</span></span><span className="tourmaster-tour-discount-price">$115</span><span className="fa fa-info-circle tourmaster-tour-price-info" data-rel="tipsy" title="The initial price based on 1 adult with the lowest price in low season"></span></div>
                        </div>
                    </div>
                </div>
            </div>
