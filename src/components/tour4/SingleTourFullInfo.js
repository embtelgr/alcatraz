                        ...
                        <div className="gdlr-core-pbf-element">
                            <div className="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr" style={{paddingBottom:'35px'}} >
                                <div className="gdlr-core-title-item-title-wrap">
                                    <h6 className="gdlr-core-title-item-title gdlr-core-skin-title" style={{fontSize:'24px', fontWeight:'600', letterSpacing:'0px', textTransform:'none'}} ><span className="gdlr-core-title-item-left-icon" style={{fontSize:'18px'}} ><i className="fa fa-file-text-o"  ></i></span>Bike Tour Summary<span className="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h6></div>
                            </div>
                        </div>
                        <div className="gdlr-core-pbf-element">
                            <div className="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                <div className="gdlr-core-text-box-item-content">
                                    <div>
                                        <img src={require('../../upload/biketourmap.jpg').default} />
                                    </div>
                                    <p>San Francisco is a good topography for a bike ride, it is a mixture of flats and hills, with nice weather and a great view. Our tour bike all-day ride, starting from 9 am till 7 pm, from Fishermens warf, passing by the national aquatic park, which has only one hill, the rest is nicely flat, which take you to the famous historical fort Mason, the Marina district, Presidio national park till you arrive at the iconic Golden Gate Bridge, some tourist come back the same way, others continue crossing the bridge on the sidewalk with an astonishing view of the city and the bay. You can even continue to the city of Sausalito in 10 minutes downhill, from there you can take the ferry to San Francisco at your own cost.</p>
                                    {/* <p>Take one of our Alcatraz Day Tours and enjoy a visit to The Rock.</p>

                                    <p>Cruise on San Francisco Bay to Alcatraz Island and the infamous and notorious former federal prison, which was home to the likes of Al Capone, George "Machine Gun" Kelley, and Robert "The Birdman" Stroud. This trip includes the audio-guided cell block tour.</p>

                                    <p>Enjoy an orientation video with historical footage, self-guided walks, and exhibits and Ranger-interpretive talks on topics such as "Famous Escapes." Also featured is an award-winning audio tour in the prison cell house with actual interviews of former guards and inmates.</p> */}
                                    ...
                                    <p>It is highly recommended to check the ferry schedule online if you want to ride the ferry from Sausalito to San Francisco.</p>
                                </div>
                            </div>
                        </div>
                        {/* <div className="gdlr-core-pbf-element">
                    ...
                    <div className="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                        ...
                        <div className="gdlr-core-pbf-element">
                            ...
                            <GallerySec 
                                images = {[
                                    {
                                        src: require('../../upload/biketour/1.jpg').default,
                                        thumbnail: require('../../upload/biketour/1.jpg').default,
                                    
                                    },
                                    {
                                        src: require('../../upload/biketour/2.jpg').default,
                                        thumbnail: require('../../upload/biketour/2.jpg').default, 
                                    
                                    },
                                    {
                                        src: require('../../upload/biketour/3.jpg').default,
                                        thumbnail: require('../../upload/biketour/3.jpg').default,   
                                    },
                                    {
                                        src: require('../../upload/biketour/4.jpg').default,
                                        thumbnail: require('../../upload/biketour/4.jpg').default,   
                                    },
                                    {
                                        src: require('../../upload/biketour/5.jpg').default,
                                        thumbnail: require('../../upload/biketour/5.jpg').default,   
                                    },
                                    {
                                        src: require('../../upload/biketour/6.jpg').default,
                                        thumbnail: require('../../upload/biketour/6.jpg').default,   
                                    }
                                ]}
                            />
                                {/* <Slider {...settings}>
                                    <div>
                                        <div className="gdlr-core-gallery-list gdlr-core-media-image">
                                            <img src={require('../../upload/photos_1.jpg').default} alt="" width="1500" height="1000" /><span className="gdlr-core-image-overlay "><i className="gdlr-core-image-overlay-icon gdlr-core-size-22 fa fa-search"  ></i></span>
                                        </div>
                                    </div>
                                    <div>
                                        <div className="gdlr-core-gallery-list gdlr-core-media-image">
