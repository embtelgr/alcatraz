                        ...
                        <div className="gdlr-core-pbf-element">
                            <div className="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr" style={{paddingBottom:'35px'}} >
                                <div className="gdlr-core-title-item-title-wrap">
                                    <h6 className="gdlr-core-title-item-title gdlr-core-skin-title" style={{fontSize:'24px', fontWeight:'600', letterSpacing:'0px', textTransform:'none'}} ><span className="gdlr-core-title-item-left-icon" style={{fontSize:'18px'}} ><i className="fa fa-file-text-o"  ></i></span>Bay Cruise Tour Summary<span className="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h6></div>
                            </div>
                        </div>
                        <div className="gdlr-core-pbf-element">
                            <div className="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                <div className="gdlr-core-text-box-item-content">
                                    <div>
                                        <img src={require('../../upload/baycruisemap.jpg').default} />
                                    </div>
                                    <p>Take advantage of prime photo opportunities with unobstructed views in every direction aboard Blue & Gold Fleet’s 60-minute San Francisco Bay Cruise. Our most popular cruise for 40+ years will have you sailing underneath the majestic Golden Gate Bridge, past the famous PIER 39 sea lions, around mysterious Alcatraz Island and along San Francisco’s historic waterfront, revealing the city’s fascinating skyline.</p>
                                    <p>This comfortable San Francisco Bay Cruise tour has both indoor and outdoor seating with full narration describing major landmarks as you sail by them. You haven’t experienced San Francisco until you’ve taken a Bay Cruise.</p>
                    ...
                    <div className="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                        ...
                        <div className="gdlr-core-pbf-element">
                            ...
                            <GallerySec 
                                images = {[
                                    {
                                        src: require('../../upload/baycruise/1s.jpg').default,
                                        thumbnail: require('../../upload/baycruise/1s.jpg').default,
                                    
                                    },
                                    {
                                        src: require('../../upload/baycruise/2.jpg').default,
                                        thumbnail: require('../../upload/baycruise/2.jpg').default, 
                                    
                                    },
                                    {
                                        src: require('../../upload/baycruise/3.jpg').default,
                                        thumbnail: require('../../upload/baycruise/3.jpg').default,   
                                    },
                                    {
                                        src: require('../../upload/baycruise/4.jpeg').default,
                                        thumbnail: require('../../upload/baycruise/4.jpeg').default,   
                                    },
                                    {
                                        src: require('../../upload/baycruise/5.jpg').default,
                                        thumbnail: require('../../upload/baycruise/5.jpg').default,   
                                    },
                                    {
                                        src: require('../../upload/baycruise/6.jpg').default,
                                        thumbnail: require('../../upload/baycruise/6.jpg').default,   
                                    }
                                ]}
                            />
                                {/* <Slider {...settings}>
