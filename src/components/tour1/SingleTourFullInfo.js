                ...
                <div className="gdlr-core-pbf-wrapper-content gdlr-core-js ">
                    <div className="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                        <div className="gdlr-core-pbf-element">
                            <div className="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr" style={{paddingBottom:'35px'}} >
                                <div className="gdlr-core-title-item-title-wrap">
                                    <h6 className="gdlr-core-title-item-title gdlr-core-skin-title" style={{fontSize:'24px', fontWeight:'600', letterSpacing:'0px', textTransform:'none'}} ><span className="gdlr-core-title-item-left-icon" style={{fontSize:'18px'}} ><i className="fa fa-file-text-o"  ></i></span>Bus Tour Summary<span className="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h6></div>
                            </div>
                        </div>
                        <div className="gdlr-core-pbf-element">
                            <div className="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                ...
                                <div>
                                    ...
                                    <p>Ride our open top bus tour is good way to explore San Francisco attractions, if you just stay on the bus the whole loop is about 2 hours 15 minutes. However, you have also the choice to hop on hop off the bus whenever you want all day, any time from 9 AM to 5 PM.</p>
                                    ...
                                    <p>Enjoy an orientation video with historical footage, self-guided walks, and exhibits and Ranger-interpretive talks on topics such as "Famous Escapes." Also featured is an award-winning audio tour in the prison cell house with actual interviews of former guards and inmates. The audio tour is available in Dutch, English, French, German, Italian, Japanese, Korean, Mandarin, Portuguese, Russian, and Spanish.</p> */}
                        ...
                        <div className="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first">
                            <div className="gdlr-core-pbf-column-content-margin gdlr-core-js ">
                                <div className="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                    <div >   <div className="gdlr-core-title-item-title-wrap">
                        ...
                        <div className="gdlr-core-pbf-element">
                            <div className="gdlr-core-gallery-item gdlr-core-item-pdb clearfix  gdlr-core-gallery-item-style-slider gdlr-core-item-pdlr ">
                                ...
                                <GallerySec 
                                    images = {[
                                        {
                                            src: require('../../upload/bustour/1.jpg').default,
                                            thumbnail: require('../../upload/bustour/1.jpg').default,
                                        
                                        },
                                        {
                                            src: require('../../upload/bustour/2.jpg').default,
                                            thumbnail: require('../../upload/bustour/2.jpg').default, 
                                        
                                        },
                                        {
                                            src: require('../../upload/bustour/3.jpg').default,
                                            thumbnail: require('../../upload/bustour/3.jpg').default,   
                                        },
                                        {
                                            src: require('../../upload/bustour/4.jpg').default,
                                            thumbnail: require('../../upload/bustour/4.jpg').default,   
                                        },
                                        {
                                            src: require('../../upload/bustour/5.jpg').default,
                                            thumbnail: require('../../upload/bustour/5.jpg').default,   
                                        },
                                        {
                                            src: require('../../upload/bustour/6.jpg').default,
                                            thumbnail: require('../../upload/bustour/6.jpg').default,   
                                        }
                                    ]}
                                />
